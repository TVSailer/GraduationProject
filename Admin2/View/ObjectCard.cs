    ...
    where T : Entity, new()
{
    ...
    protected override void OnParentChanged(EventArgs e)
    {
        ...
        if (Parent != null)
        {
            Parent.MouseClick += (s, args) =>
            {
                ...
                if (hitControl == null || !(hitControl is ObjectCard<T>))
                {
                    ResetHighlight();
                }
            };
    ...
    public ObjectCard<T> OnContextMenu(IButtons<CardClickedArgs<T>>? buttonsContextMenu)
    {
        ...
        var buttons = buttonsContextMenu.GetButtons();
        buttons.ForEach(b => b.OnClick(this, new CardClickedArgs<T>(entity)));
    ...
    public ObjectCard<T> OnClickedCard(Action<object, CardClickedArgs<T>>? action)
    {
        OnCardClicked += (s, e) => action?.Invoke(this, new CardClickedArgs<T>(entity));
        return this;
    }
}
