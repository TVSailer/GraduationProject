...
public class EventAddingPanelViewModel : General.ViewModel.ViewModel
{
    ...
    public EventAddingPanelViewModel(IRepository<EventEntity> repositoryE, IRepository<CategoryEntity> repositoryC, IServiceImage serviceImage, IServiceControlView serviceControlView)
    {
