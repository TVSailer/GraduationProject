...
namespace Logica
{
    ...
    {
        private static List<TableLayoutPanel> tables = [];

        public static TableLayoutPanel NewRowSize(this TableLayoutPanel table, int size)
        {
        ...
        public static TableLayoutPanel EndRow(this TableLayoutPanel table)
        {
        ...
        public static TableLayoutPanel ControlAddIsColumn(
            this TableLayoutPanel table, Control? control, ColumnStyle style)
            => control == null
                ? table
                    .ControlAddIsColumn(new Panel(), style)
                : table
                    .AddingColumnsStyles(style)
                    .AddControlColumn(control);
