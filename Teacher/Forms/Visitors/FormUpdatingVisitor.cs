...
{
    public partial class FormUpdatingVisitor : Form
    {
        ...
        public FormUpdatingVisitor(VisitorPresent present, DataGridViewRow row)
        {
            ...
            dateBirth.Text = present.DateBirth = row.Cells[4].Value.ToString();
            ...
            textBox2.Text = present.Surname = row.Cells[2].Value.ToString();
            ...
            textBox3.Text = present.Patronymic = row.Cells[3].Value.ToString();
            ...
            textBox4.Text = present.NumberPhone = row.Cells[5].Value.ToString();
