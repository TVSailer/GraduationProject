...
namespace UserInterface.UiObjects.Factory;
...
public static class FactoryElements
{
    ...
    public static ComboBox ComboBox()
    {
        return new ComboBox()
            ...
            .With(cb => cb.SelectedIndexChanged += (_, _) => cb.DataBindings["SelectedItem"]?.WriteValue())
    ...
    public static TextBox TextBox(bool multiline, bool readOnly = true)
    {
        return TextBox()
    ...
    public static Label Label(string text, int size)
    {
        return new Label()
            ...
            .With(l => l.Font = new Font("Times New Roman", size, FontStyle.Bold))
    ...
    public static PictureBox PictureBox(string imgUrl)
    {
        return new PictureBox()
            ...
            .With(img => img.MouseDoubleClick += (_, _) => FullSizeImage(imgUrl));
    }
