...
{
    public IColumnBuilder CreateColumn(float width = 100, SizeType sizeType = SizeType.Percent)
    {
        return new TableColumnBuilder(new ColumnStyle(sizeType, width));
    }

    public IRowBuilder CreateRow(float height = 100, SizeType sizeType = SizeType.Percent)
    {
