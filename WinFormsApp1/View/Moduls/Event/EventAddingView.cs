...
{
    public partial class EventAddingView : IViewForm
    {
        private ErrorProvider errorProvider = new() { BlinkStyle = ErrorBlinkStyle.NeverBlink };
        private readonly EventAddingViewModel context;
        private readonly AdminMainView form;

        public EventAddingView(AdminMainView mainForm, EventAddingViewModel context)
        {
