...
//            .With(f => f.LabelText = "Добавление преподователя")
...
//                            .With(t => t.TextChanged += (s, e) => context.Name = t.LabelText)
...
//                            .With(t => t.TextChanged += (s, e) => context.Surname = t.LabelText)
...
//                            .With(t => t.TextChanged += (s, e) => context.NumberPhone = t.LabelText)
