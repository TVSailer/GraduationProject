...
namespace Admin.View.Teachers
{
    public class AddingTeacherView : IViewForm
    {
        private ErrorProvider errorProvider = new() { BlinkStyle = ErrorBlinkStyle.NeverBlink };
        private readonly AddingTeacherViewModel context;
        private readonly AdminMainView form;

        public AddingTeacherView(AdminMainView mainView, AddingTeacherViewModel modelView)
        {
            form = mainView;
            context = modelView;
        }
        ...
        private TableLayoutPanel CreateUI()
            => FactoryElements
                ...
                .ControlAddIsRowsPercentV2(new Panel())
        ...
        private TableLayoutPanel CreateButtonPanel()
            => FactoryElements.TableLayoutPanel()
                ...
                .ControlAddIsColumnPercentV2(FactoryElements.Button("💾 Сохранить", context, nameof(context.OnSave)), 40)
